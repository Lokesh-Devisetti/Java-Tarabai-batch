...
public class DaoImpl {
	...
	public void update() throws SQLException {
		...
		String name=sc.next();
		int i=st.executeUpdate("update tarabai set name='"+name+"' where id='"+id+"'");
		if(i>=1) {
	...
	int id=sc.nextInt();
		int i=st1.executeUpdate("delete from tarabai where id='"+id+"'");
		if(i>=1) {
...
Statement st2=con.createStatement();
		...
		ResultSet rs=st2.executeQuery("select * from tarabai");
